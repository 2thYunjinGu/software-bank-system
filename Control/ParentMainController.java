...
public class ParentMainController {
    private ParentMainView parentMainView;
    private User user;

    public ParentMainController(ParentMainView parentMainView, User user) {
    ...
    private void initView() {
        ...
        parentMainView.getReturnToLoginButton().addActionListener(e -> returnToLogin());
